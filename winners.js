const winnersTableTr = document.getElementById("winnersTableTr")

window.onload = () => {
    fetch("https://site138.webte.fei.stuba.sk/zadanie1/be/getWinnersList.php")
        .then(response => {
        ...
        "columnDefs": [
            {
                ...
                <div class="flex flex-row gap-x-2 items-center justify-center">
                    <button 
                        ...
                        onclick="getEditPerson(this, '#winnersTable')"
                    >
                    ...
                    <button 
                        ...
                        onclick="deletePerson(this, '#winnersTable')"
                    >
